...
import 'package:app_33_pet_routine_planner/app.dart';
import 'package:app_33_pet_routine_planner/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('반려동물 루틴 플래너'), findsWidgets);
